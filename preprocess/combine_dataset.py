...
for fn in ["valid", "test", "train"]:
    fr_dnli = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original_dialogueNLI.txt".format(fn), "r")
    fr_tnli = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original_BERT.txt".format(fn), "r")
    fr_tfidf = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original_tfidf.txt".format(fn), "r")
    fw = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original_final.tsv".format(fn), "w")

    lines_dnli = fr_dnli.readlines()
    lines_tnli = fr_tnli.readlines()
    lines_tfidf = fr_tfidf.readlines()

    print("DNLI: ",lines_dnli)
    print("TNLI: ",lines_tnli)
    print("TFI-DF: ",lines_tfidf)
