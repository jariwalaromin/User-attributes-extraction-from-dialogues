...
#sentance to triples mapping
s2t_map = {}
triple_set = set()
for fn in ["dev", "test", "train"]:
    data = jsonlines.Reader(open('C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/dialogue_nli/dialogue_nli_{}.jsonl'.format(fn), 'r')).read()
    for d in data:
...
print("Triplet Set: ",triple_set)

both_persona = []
file_name = ["valid", "test", "train"]

for fn in file_name:
    fr = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original.txt".format(fn), "r")
    lines = fr.readlines()
...
for fn in file_name:
    fr = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original.txt".format(fn), "r")
    fw = open("C:/Users/mrper/Desktop/24[7]ai/GettingToKnowYou-master/data/ConvAI2/{}_both_original_BERT.txt".format(fn), "w")
    lines = fr.readlines()
    ...
    for line in bar: 
        ...
        if "partner's persona: " in line:
            ...
            #if not there in s2t_map then predict label using bert (for uttrances)
        else:
            # partner_uttr = " ".join(line.split("\t")[0].split()[1:])
            partner_uttr = line.split("\t")[0]
            your_persona_uttr = line.split("\t")[1]
            
            #print("Partener_Persona:",partner_parsona,"\t Partner_Persona_Triplet:",partner_parsona_triple)
            #print("\n Your_Persona:",your_persona,"\t Your_Persona_Triplet:",your_persona_triple)
            ...
            #print("imply_persona_partner: ",imply_persona_partner)
            #print("\n imply_persona_your: ",imply_persona_your)
            
            
         
            #writing in file after prediction of triple for uttrances.
