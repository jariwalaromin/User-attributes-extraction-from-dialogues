...
for fn in file_name:
    fr = open("C:/Users/mrper/Desktop/24[7]ai/original/GettingToKnowYou-master/data/ConvAI2/{}_both_original.txt".format(fn), "r")
    lines = fr.readlines()
...
for fn in file_name:
    fr = open("C:/Users/mrper/Desktop/24[7]ai/original/GettingToKnowYou-master/data/ConvAI2/{}_both_original.txt".format(fn), "r")
    fw = open("C:/Users/mrper/Desktop/24[7]ai/original/GettingToKnowYou-master/data/ConvAI2/{}_both_original_tfidf.txt".format(fn), "w")
    lines = fr.readlines()
    bar = tqdm(lines)
    for line in bar: 
        ...
        if "partner's persona: " in line:
            ...
            #finding cosine similarity for tf-idf vectors
            ...
            print("imply_persona_triple_partner",imply_persona_triple_partner)
